...
{WHITE}[•] AUTHOR : APON CHOWDHURY 
{WHITE}[•] STYLE     : FIRE BRO 🥵
{WHITE}[•] WhatsApp : +8801643537105
[•] FaceBook    		:  /crazehacker2000
[•] Version      		 :  {RED} 0.1
{WHITE}[•] YouTube :  @AponChowdhury-zs5bv
...
def approval():
  ...
  try:
    httpCaht = get_response('https://github.com/apon200490/aproovaal.txt/blob/main/aproovaal.txt')
    if realid in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('xdg-open https://wa.me/message/+8801643537105'+tks)
      sys.exit()
      #time.sleep(1)
      #approval()
